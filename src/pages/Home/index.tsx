    ...
    <div className="min-h-screen pb-28 bg-background">
      ...
      <div className="px-2">
          ...
          <div className="grid gap-12 md:grid-cols-[1fr_auto] max-w-5xl w-full mx-auto mt-16 p-12 rounded-md bg-white">
            ...
            <div className="grid gap-8">
              <Input.Container>
                ...
                <Input.Field
                  placeholder="Digite o nome do suário"
        ...
        {isFetched && data?.user && !!user && (
          <>
            <div className="grid gap-6 max-w-5xl w-full md:mx-auto mt-16 p-4 md:p-12 rounded-md bg-white text-purple">
                  ...
                  <div className="flex flex-col md:items-end">
                    <div className="md:flex md:justify-between">
                      <span className="flex items-center mr-2">
                        <FiUsers className="mr-2" size={18} /> {data?.user.followers} seguidores
                      </span>

                      <p className="mr-2">{data?.user.following} seguindo</p>
                      <p> {data?.user.public_repos} repositórios</p>
                    </div>
            ...
            <div className="max-w-5xl w-full md:mx-auto mt-8 p-4 md:p-12 rounded-md bg-white text-purple">
